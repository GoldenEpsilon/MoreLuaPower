...
{
	static void Prepare() {
		Debug.Log("MoreLuaPower Version 2.7.6");
		LuaPowerData.Setup();
        ...
        if (!LuaPowerData.customEnums[typeof(FTrigger)].Contains("OnTileCrack")) { LuaPowerData.customEnums[typeof(FTrigger)].Add("OnTileCrack"); }
    }
